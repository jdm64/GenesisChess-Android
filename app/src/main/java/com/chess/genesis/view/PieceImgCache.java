...
public class PieceImgCache
{
	...
	public PieceImgCache(Context context)
	{
		try {
			var cntx = context.createPackageContext(context.getPackageName(), Context.CONTEXT_INCLUDE_CODE);
	...
	private static Bitmap loadImage(int id, int isize)
	{
	...
	public Bitmap getPieceImg(int index)
	{
	...
	public Bitmap getCountImg(int index)
	{
